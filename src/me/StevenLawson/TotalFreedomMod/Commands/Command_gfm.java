...
public class Command_gfm extends TFM_Command
{
    @Override
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        playerMsg("GalaticFreedomMod for 'Galatic Freedom'", ChatColor.GOLD);
        ...
        playerMsg("Created by Madgeek1450 and Prozza, Edited by: Operatinq. Do /tfm for orginal information", ChatColor.GOLD);
